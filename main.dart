...
// Importa tu archivo de configuración de Firebase (firebase_options.dart)
// import 'firebase_options.dart';

void main() async {
  // Asegúrate de que los widgets de Flutter estén inicializados
  WidgetsFlutterBinding.ensureInitialized();
  // Inicializa Firebase (descomenta cuando tengas tu configuración)
