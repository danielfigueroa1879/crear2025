import 'package:bitacora_carabineros/models/procedimiento_model.dart'; // Ajustado a la nueva ruta
import 'package:bitacora_carabineros/services/firestore_service.dart'; // Ajustado a la nueva ruta
...
class _NuevoProcedimientoScreenState extends State<NuevoProcedimientoScreen> {
  ...
  void _guardarProcedimiento() {
    if (_formKey.currentState!.validate()) {
      // Aquí creamos el objeto Procedimiento con los datos del formulario
            ...
            children: [
              ...
              TextFormField(
                ...
                decoration: const InputDecoration(
                    ...
                    border: OutlineInputBorder(),
                    suffixIcon: Icon(Icons.mic)), // Icono para futura función de voz a texto
                maxLines: 5,
                validator: (value) =>
